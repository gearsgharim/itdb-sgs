...
<div id="tab1" class="tab_content">
  ...
  //licensetype
  $t0="";$t1="";$t2="";$t3="";
  if (empty ($lictype) || $lictype=="0") {$t0="checked";$t1="";$t2="";$t3="";}
  if ($lictype=="1") {$t1="checked";$t0="";$t2="";$t3="";}
  if ($lictype=="2") {$t2="checked";$t0="";$t1="";$t3="";}
  if ($lictype=="3") {$t3="checked";$t0="";$t1="";$t2="";}
  ?>
    <tr>
    <td class='tdt'>License Per:</td>
    <td>
    <input style='width:1%' type=radio <?php echo $t0?> name='lictype' value='0'>Box
    <input style='width:1%' type=radio <?php echo $t1?> name='lictype' value='1'>CPU
    <input style='width:1%' type=radio <?php echo $t2?> name='lictype' value='2'>Core
	<input style='width:1%' type=radio <?php echo $t3?> name='lictype' value='3'>Vol
    </td>
    </tr>
...
<div id='tab2' class='tab_content'>
  ...
  <tr>
    ...
    <div style='margin-left:auto;margin-right:auto;' class='scrltblcontainer2'>
	 ...
	 <thead>
	    <tr><th><?php te("Installed");?></th><th style='width:70px'><?php te("ID");?></th>
