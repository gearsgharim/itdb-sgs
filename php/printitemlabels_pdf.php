...
//$sql="SELECT items.id,model,sn,sn3,itemtypeid,dnsname,label, agents.title as agtitle FROM items,agents ".
//     " WHERE agents.id=items.manufacturerid AND items.id in ($ids) order by itemtypeid, agtitle, model,sn,sn2,sn3,label";
$sql="SELECT items.id,model,sn,itemtypeid,name,label,agents.title as agtitle FROM items,agents ".
