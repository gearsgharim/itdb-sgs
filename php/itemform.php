...
<div id="tab1" class="tab_content">
  ...
  <td class='tdtop'>
    ...
    ?>
      ...
      <tr> <td class='tdt'><?php te("Order No");?>:</td><td> <textarea wrap='soft' class=tarea1  name='comments'><?php echo $comments?></textarea></td> </tr>
	...
	echo "<option $s value='$dbid'>$itype</option>\n";
	  ...
	  <tr>
	<td class='tdt' title='<?php te("describe the purpose of this item");?>'><?php te("Division");?>:</td>
	<td title='<?php te("What the division?");?>'><input type=text size=15 value="<?php echo $division?>" name='division'></td> 
      </tr>
	...
	<select id='locareaid' name='locareaid'>
      ...
      <tr>
      <td class='tdt'><?php te("History 1");?>:</td><td title='<?php te("History about usage");?>'>
       <textarea wrap='soft' class=tarea1 name='history'><?php echo $history?></textarea></td>
      </tr>

	  <td class='tdt'><?php te("History 2");?>:</td><td title='<?php te("History about usage");?>'>
       <textarea wrap='soft' class=tarea1 name='history2'><?php echo $history2?></textarea></td>
      </tr>
	  
	  <td class='tdt'><?php te("History 3");?>:</td><td title='<?php te("History about usage");?>'>
       <textarea wrap='soft' class=tarea1 name='history3'><?php echo $history3?></textarea></td>
      </tr>
...
<div id='tab2' class='tab_content'><!-- Associations -->
  ...
  <table border='0' class='tbl2' style='width:100%;border-bottom:1px solid #cecece'><!-- connect to other items -->
    ...
    <tr><td colspan=2>
      ...
      <thead><tr><th><?php te("Rel");?></th><th><?php te("ID");?></th>
	  <th style='width:8em'><?php te("Type");?></th>
	  <th><?php te("Manufacturer");?></th>
                 <th><?php te("Model");?></th><th><?php te("Asset Number");?></th><th><?php te("DNS");?></th>
                 <th><?php te("Users");?></th><th><?php te("Serial Number");?></th></tr></thead>
      <tbody>
<?php 
//////////////////////////////////////////////
...
//not linked items
$sql="SELECT items.id,manufacturerid,model,itemtypeid, sn || ' '||sn2 ||' ' || sn3 as sn,label,division,dnsname, users.username AS username".
