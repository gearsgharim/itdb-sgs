...
$formvars=array("itemtypeid","division","manufacturerid","label",
  ...
  "comments","history","history2","history3","ispart","hd",
  "cpu","cpuno","corespercpu", "ram", "usize","status",
...
if (isset($_GET['cloneid'])) { 
  $cols="itemtypeid , division, manufacturerid ,model,origin,warrantymonths ,purchasedate ,purchprice, history, history2, history3,".
        "comments,ispart ,hd,cpu,ram,locationid ,usize ,label,status,cpuno , corespercpu , warrinfo";
...
elseif (isset($_POST['itemtypeid']) && ($_GET['id']=="new")&&isvalidfrm()) {
  ...
  //// STORE DATA
  $sql="INSERT into items (label, itemtypeid, manufacturerid, ".
  " warrinfo, model, sn, sn2, sn3, origin, warrantymonths, purchasedate, purchprice, ".
  " dnsname, userid, division, locationid, locareaid, history, history2, history3, ".
  " comments,ispart, ".
  ...
  " '$purchprice', '$dnsname', $userid, '$division', '$locationid', '$locareaid', '$history', '$history2','$history3', ".
