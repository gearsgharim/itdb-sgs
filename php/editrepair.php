...
if (isset($_GET['delid'])) { 
  ...
  echo "<script>document.location='$scriptname?action=listitemsrepair'</script>";
  echo "<a href='$scriptname?action=listitemsrepair'>Go here</a></body></html>"; 
  exit;
}

if (isset($_GET['cloneid'])) { 
  $cols="itemtypeid, division, manufacturerid, label, model, sn, sn2,sn3".
        "userid, comments,ispart, locationid ,locareaid, problem , solution , replacement , repairdate , finishdate , statusrepair";
...
//check for arguments
if (!isset($_GET['id'])) {echo "editrepair:missing arguments";exit;}
