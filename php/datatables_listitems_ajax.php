<?php
	 ...
	 */
	$aColumns = array('itemid','typedesc','title','itemmodel','serial','itemlabel','orderno','purchasedate','username',
	'division','statusdesc','locationname','areaname','history','history2','history3');
	...
	if ( $sWhere != "" )
	{
		  ...
		  items.comments AS orderno,
		  items.division AS division,
		  items.purchasedate AS purchasedate,
		  items.history AS history,
		  items.history2 AS history2,
		  items.history3 AS history3,
